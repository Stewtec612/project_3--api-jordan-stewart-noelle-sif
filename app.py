...
def mystic_results():
    ...
    return render_template('results.html', animal_name=full_animal_info[0], horoscope=horoscope, animal_image_url=full_animal_info[1], tarot_card_name=tarot_card_name,tarot_card_meaning=tarot_card_meaning)
