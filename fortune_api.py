...
def get_animal_name():
    animal_api(animal_api.animal_name_request)


def get_animal_picture():
    animal_api(animal_api.animal_picture_request)

def get_horoscope():
    horoscope_api(horoscope_api.horoscope_details)

def tarot_card():
    tarot_api(tarot_card)
